...
namespace Namespace
{
    ...
    {
        static System.UInt64 Number = 0;
        static System.UInt64 Number2 = 0;
        static System.String File = "File.txt";
        static System.String File2 = "File.txt";
        static System.String Contents = System.String.Empty;
        static System.Exception Exception;
        static readonly System.UInt64 Number3 = System.UInt64.MaxValue;
        static void Main()
        {
            if (!System.IO.File.Exists(Namespace.Class.File)) System.IO.File.WriteAllText(Namespace.Class.File, "Goodbye Cruel World!" + System.Environment.NewLine);
            ...
            System.Console.Out.Flush();
            if (System.Console.ReadLine().ToUpper().Contains("Y")) Namespace.Class.End();
